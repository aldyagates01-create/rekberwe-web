(function initRekberI18n(global) {
  ...
  const MESSAGES = {
    id: {
      ...
      "voucher.select_bank": "Pilih metode pembayaran",
      "voucher.scan_qris": "Scan QRIS",
      "voucher.qris_hint": "Scan kode QR di atas via e-wallet atau m-banking, lalu upload bukti pembayaran.",
